...
<body>
    <div class="register-container">
        ...
        <form method="POST" action="register.php" id="registerForm">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control <?php echo isset($response['errors']['apellido']) ? 'is-invalid' : ''; ?>" 
                           id="apellido" name="apellido" placeholder="Perez" value="<?php echo $_POST['apellido'] ?? ''; ?>" required>
            ...
            <div class="form-row">
                <div class="form-group">
                    <label for="curso_division" class="form-label">Curso/Division</label>
                    <select class="form-control" id="curso_division" name="curso_division" required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="materia" name="materia" 
                           placeholder="ej: Electronica" value="<?php echo $_POST['materia'] ?? ''; ?>">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="password" class="form-control <?php echo isset($response['errors']['password']) ? 'is-invalid' : ''; ?>" 
                           id="password" name="password" placeholder="Minimo 6 caracteres" required>
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control <?php echo isset($response['errors']['confirm_password']) ? 'is-invalid' : ''; ?>" 
                           id="confirm_password" name="confirm_password" placeholder="Confirma tu contrasena" required>
